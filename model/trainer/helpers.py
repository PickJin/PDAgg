...
from model.dataloader.samplers import CategoriesSampler, RandomSampler, ClassSampler, OpenCategoriesSampler
...
def get_dataloader(args):
    ...
    train_sampler = OpenCategoriesSampler(trainset.label,
                                      num_episodes,
    ...
    valset = Dataset(args, 'val', False)
    val_sampler = OpenCategoriesSampler(valset.label,
    ...
    testset = Dataset(args, 'test', False)
    test_sampler = OpenCategoriesSampler(testset.label,
